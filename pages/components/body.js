        ...
        <div className={styles.parent_wrapper}>
          ...
          <ol className={styles.everything_wrapper}>
            ...
            <div class={styles.tabber}>
              ...
              <div className={styles.tabber_wrapper}>

                <ul className={styles.tabber_main_list}>
                ...
                <ul className={styles.promo_messages} >
                  ...
                  <li className={styles.promo_message2}>
                    <Link
                      href="/services"
                    >
                      <p>Apply promo code <span className={styles.promo_code}>"STELLAR19950202" </span> to get 60% OFF</p>
                    </Link>
                  </li>
                </ul>
